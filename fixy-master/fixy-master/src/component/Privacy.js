...
function Privacy() {
  return (
    <div className="privacy">
      ...
      <div>
        At FIXY, accessible from Fixy.help, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by FIXY and how we use it. If
        ...
        in FIXY. This policy is not applicable to any information collected
        offline or via channels other than this website. Consent By using our
        website, you hereby consent our privacy policy and agree to its terms
        ...
        purposes Send you emails Find and prevent fraud Log Files FIXY follows a
        ...
        other website, FIXY uses 'cookies'. These cookies are used to store
        ...
        information on cookies, please read "What Are Cookies" from Cookie
        Consent. Google DoubleClick DART Cookie Google is one of a third-party
        ...
        for each of the advertising partners of FIXY. Third-party ad servers or
        ...
        on FIXY, which are sent directly to users' browser. They automatically
        ...
        visit. Note that FIXY has no access to or control over these cookies
        that are used by third-party advertisers. Third Party Privacy Policies
        FIXY's Privacy Policy does not apply to other advertisers or websites.
        ...
        participate in, and/or monitor and guide their online activity. FIXY
